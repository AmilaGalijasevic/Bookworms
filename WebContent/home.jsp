...
<body id="page-top" class="index">
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a class="page-scrol" href="#share">SHARE </a></li>
				<li><a class="page-scrol" href="#list">list</a></li>
	...
	<div class="container">
		<div class="intro-text">
			...
			<a href="#share" class="page-scroll btn btn-xl">Share your
				favorite books</a>
		</div>
	</div>
	</header>
						...
						<div class="timeline-panel">
							...
							<div class="timeline-body">
								<p class="text-muted">Our mission is to bring book lovers
									...
									enjoyable and that you would recommend it to other booklovers.
								</p>
							</div>
						</div>
					</li>
